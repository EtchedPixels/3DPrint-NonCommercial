...
module cab_windows() {
	translate([-0.5, 12.0, 0.86])
		cube([11, 1.8, 3.3]);
	translate([-0.5, 12.0, 12.7-0.86-3.3])
		cube([11, 1.8, 3.3]);
}

module cab_roof() {
	translate([10,16.7,6.3])
	rotate([0,90,180])
...
module body_48ds() {
	difference() {
		union() {
			...
			translate([0, 10.9, 6.35])
				nose_shape();
			// Front cap
			translate([21.8, 11.2, 6.35])
				rotate([90,0,0])
					cylinder(r=0.3,h=1.2, $fn=16);
			// Back cap
			translate([11.5, 11.2, 6.35])
				rotate([90,0,0])
					cylinder(r=0.3,h=1.2, $fn=16);
			// Cab
			translate([0,2.99,0])
			...
			translate([21.3,4.5, 11.1])
				rotate([90,0,0])
					cylinder(r=0.4, h=1.8, $fn=16);
			// Lights
			translate([5,14.14,6.35])
				rotate([0,90,0])
					cylinder(r=0.25, h=11, $fn=16, center=true);
			translate([-0.49, 14, 6.35])
				lamp(1);
			translate([10.49, 14, 6.35])
				lamp(0);
			// Door grooves
			if (raised_door == 1) {
				translate([8.4, 3, -0.1])
				...
				translate([5.65, 3, -0.1])
					cube([0.2, 11.3, 0.1]);
				translate([8.4,3, 12.7])
					cube([0.2, 11.3, 0.1]);
				translate([5.65,3,12.7])
					cube([0.2, 11.3, 0.1]);
			}
		...
		translate([12.15, 8.4, 2.89])
			cube([8,0.1,0.1]);
		translate([12.15, 5.71, 9.71])
			cube([8,0.1,0.1]);
		translate([12.15, 8.4, 9.71])
			cube([8,0.1,0.1]);
		translate([16.15, 3, 2.89])
			cube([0.1, 5.4, 0.1]);
		translate([16.15, 3, 9.71])
			cube([0.1, 5.4, 0.1]);
		// coupling slot
		translate([-1, 2.6, 6.2])
			cube([25, 1, 0.3]);
	...
	if (grilles == 1) {
		...
		translate([21.8, 3.5, 4.0])
			mesh(5.5,5.5);
		translate([12.65, 6.1, 2.8])
			grilles();
		translate([14.55, 6.1, 2.8])
			grilles();
		translate([16.75, 6.1, 2.8])
			grilles();
		translate([18.45, 6.1, 2.8])
			grilles();
		translate([12.65, 6.1, 9.7])
			grilles();
		translate([14.55, 6.1, 9.7])
			grilles();
		translate([16.75, 6.1, 9.7])
			grilles();
		translate([18.45, 6.1, 9.7])
			grilles();
	}
	// Steps
	translate([6.3, -0.2, 12.25])
		right_bodyside_step();
	...
	translate([15.30,0, -0.2])
		left_axlebox();
	translate([4.82, 0, 12.15])
		right_axlebox();
	translate([15.30, 0, 12.15])
		right_axlebox();
}
...
module body_48ds_3mm() {
	scale(148.0/100.0)
		body_48ds();
}

module body_48ds_7mm() {
	scale(148.0/43.5)
		body_48ds();
}
